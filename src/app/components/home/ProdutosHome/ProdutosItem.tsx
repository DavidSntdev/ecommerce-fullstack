...
export default function ProdutosItem(props: ProdutosItemProps) {
  return (
    <Card
      ...
      className="w-[75%] lg:w-[90%] border-1 border-default-300 rounded-md justify-self-center"
      shadow="md"
    >
      <CardBody className="overflow-visible relative p-0">
        ...
        <footer className="flex sm:flex-col justify-between sm:justify-normal gap-1 px-3 py-2">
          <Link
